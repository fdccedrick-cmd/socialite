...
<div class="w-full bg-white lg:rounded-xl lg:shadow-sm lg:border lg:border-gray-100 p-3 lg:p-4 lg:sticky lg:top-20 h-full lg:h-fit">
  ...
  <nav class="space-y-1 mb-4">
    ...
    <a 
      ...
      class="flex items-center gap-3 px-3 py-2.5 lg:py-2 rounded-lg transition-colors <?= str_contains($currentPath, '/friendships') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50' ?>"
    >
