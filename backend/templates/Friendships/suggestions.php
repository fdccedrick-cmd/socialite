<div id="suggestionsApp" class="max-w-4xl mx-auto p-4 sm:p-6" v-cloak>
    ...
    <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 truncate">@{{ suggestion.username }}</p>
                            <p class="text-xs sm:text-sm text-gray-500 mt-1" v-if="suggestion.mutual_friends_count > 0">
        ...
        <div v-else class="bg-white rounded-lg shadow-sm p-8 sm:p-12 text-center">
            <i data-lucide="user-search" class="w-16 h-16 text-gray-400 mx-auto mb-4"></i>
            <h3 class="text-xl font-semibold text-gray-900 mb-2">No suggestions available</h3>
