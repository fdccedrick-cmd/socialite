<div id="friendshipsApp" class="max-w-4xl mx-auto p-4 sm:p-6" v-cloak>
            ...
            <form method="get" action="/friendships/index">
                <div class="relative">
                    <input 
                        ...
                        class="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                    >
                    <i data-lucide="search" class="w-5 h-5 text-gray-400 dark:text-gray-500 absolute left-3 top-1/2 -translate-y-1/2"></i>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- Tabs -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-4 border border-gray-100 dark:border-gray-700">
    ...
    <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 truncate">@{{ friend.username }}</p>
                    ...
                    <div class="ml-3 flex-shrink-0">
                        <button
                            ...
                            class="flex items-center space-x-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg font-medium transition-colors"
                        >
        ...
        <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-8 sm:p-12 text-center">
            <i data-lucide="users" class="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4"></i>
