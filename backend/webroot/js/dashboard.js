    ...
    methods: {
        ...
        async toggleImageLike() {
            ...
            try {
                ...
                console.log('[Image-Like] Response status:', response.status);
                console.log('[Image-Like] Response headers:', [...response.headers]);
                
                const responseText = await response.text();
                console.log('[Image-Like] Response body:', responseText);
